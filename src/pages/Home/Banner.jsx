    ...
    return (
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src={sixth} className="lg:max-w-sm w-full rounded-lg mb-8 lg:mb-0 shadow-2xl" />
                <div className='lg:w-1/2 lg:pr-6'>
                    <h1 className="text-5xl text-teal-950 font-serif">Authentic Thai Recipes from Top Chefs</h1>
