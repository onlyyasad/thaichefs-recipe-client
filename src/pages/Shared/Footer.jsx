...
const Footer = () => {
    return (
        <div className='px-4 bg-teal-950'>
            <div className='container mx-auto py-16 text-white'>
                <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-4'>
                    <div>
                        <h2 className='font-bold text-2xl my-4'>Subscribe to Newsletter!</h2>
                        ...
                        <div className="my-4">
                            ...
                            <button className="btn bg-black border-none rounded-none">
                                Subscribe
                            </button>
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div>
                            <h2 className='font-bold text-2xl my-4'>Info</h2>
                            <ul>
